let config = {
  ...
  metadata:
    "eec669dfd567f0f57899522e8a720e703359cfc748adc04ff9c026094a85f645i0",
  fallbackImage:
    "e3e932692c8209250207433c01abbec31cf763e7684bbebbbeff7b23fa406994i0",
  key: "50572aca00b709c3660cedd992b11839cb531b8415bc7fe2c47d036baf4f2301i0",
};

window.setCSS = function(style) {
  const css = Object.entries(style).map(([selector, props]) => {
...
async function decrypt(data) {
  ...
  data = await crypto.subtle.decrypt({ name: "AES-GCM", iv: keyData.slice(0, 12) }, importedKey, await data.arrayBuffer())
